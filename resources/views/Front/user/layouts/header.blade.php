            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ url('/') }}">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center"><img
                            src="{{ asset('Backend_assets/assets/img/icons/logo.png') }}" alt="phoenix"
                            width="27" />
                        <p class="logo-text ms-2 d-none d-sm-block">Tech</p>
                    </div>
                </div>
            </a>
        </div>
                    ...
                    <div class="list pb-3">
                        ...
                        <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                ...
                                <div class="file-thumbnail me-2"><img class="h-100 w-100 fit-cover rounded-3"
                                        src="{{ asset('Backend_assets/assets/img/products/60x60/3.png') }}"
                                        alt="" /></div>
                                <div class="flex-1">
                        ...
                        <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                ...
                                <div class="avatar avatar-l status-online  me-2 text-900">
                                    <img class="rounded-circle "
                                        src="{{ asset('Backend_assets/assets/img/team/40x40/10.webp') }}"
                                        alt="" />
                                </div>
                                <div class="flex-1">
                            ...
                            <a class="dropdown-item py-2 d-flex align-items-center" href="pages/members.html">
                                <div class="avatar avatar-l  me-2 text-900">
                                    <img class="rounded-circle "
                                        src="{{ asset('Backend_assets/assets/img/team/40x40/12.webp') }}"
                                        alt="" />
                                </div>
                                <div class="flex-1">
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        ...
                                                        src="{{ asset('Backend_assets/assets/img/team/40x40/30.webp') }}"
                                                        alt="" /></div>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        ...
                                                        src="{{ asset('Backend_assets/assets/img/team/40x40/avatar.webp') }}"
                                                        alt="" />
                                                </div>
                                                <div class="flex-1 me-sm-3">
                                                    <h4 class="fs--1 text-black">Jessie Samson</h4>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        class="rounded-circle"
                                                        src="{{ asset('Backend_assets/assets/img/team/40x40/57.webp') }}"
                                                        alt="" /></div>
                                                <div class="flex-1 me-sm-3">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        class="rounded-circle"
                                                        src="{{ asset('Backend_assets/assets/img/team/40x40/59.webp') }}"
                                                        alt="" /></div>
                                                <div class="flex-1 me-sm-3">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m status-online me-3"><img
                                                        class="rounded-circle"
                                                        src="{{ asset('Backend_assets/assets/img/team/40x40/58.webp') }}"
                                                        alt="" /></div>
                                                <div class="flex-1 me-sm-3">
                        ...
                        <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/behance.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/google-cloud.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/slack.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/gitlab.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/bitbucket.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/google-drive.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/trello.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/figma.webp') }}"
                                            alt="" width="20" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/twitter.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/pinterest.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/ln.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/google-maps.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/google-photos.webp') }}"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('Backend_assets/assets/img/nav-icons/spotify.webp') }}"
                                            alt="" width="30" />
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                    ...
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle "
                            src="{{ asset('Backend_assets/assets/img/team/40x40/57.webp') }}" alt="" />
                    </div>
                </a>
                            ...
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl ">
                                    @if (auth()->check())
                                        ...
                                        <span class="rounded-circle" style="background: antiquewhite; padding: 12px;font-size: 20px;">{{ $initials }}</span>
                                    @endif
    ...
    <div class="collapse navbar-collapse justify-content-between">
        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0 white-space-nowrap" id="navbarDropdownUser"
                    ...
                    data-bs-auto-close="outside" aria-expanded="false">Olivia
                    ...
                    <div class="card position-relative border-0">
                        <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl ">
                                    <img class="rounded-circle "
                                        src="{{ asset('Backend_assets/assets/img/team/72x72/57.webp') }}"
                                        alt="" />
                                </div>
...
<nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
    ...
    <ul class="navbar-nav navbar-nav-icons flex-row">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1 me-sm-3">
                                                ...
                                                <p class="fs--1 text-1000 mb-2 mb-sm-3 fw-normal"><span
                                                    ...
                                                    comment.<span class="ms-2 text-400 fw-bold fs--2">1h</span></p>
                                                <p class="text-800 fs--1 mb-0"><span
        ...
        <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                ...
                aria-expanded="false">
                <div class="avatar avatar-l ">
                    <img class="rounded-circle " src="{{ asset('Backend_assets/assets/img/team/40x40/57.webp') }}"
                        alt="" />
                </div>
            </a>
            <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border border-300"
