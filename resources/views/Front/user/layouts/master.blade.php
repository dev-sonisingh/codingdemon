...
<head>
    ...
    <link href="{{ asset('Backend_assets/assets/css/theme-rtl.min.css') }}" type="text/css" rel="stylesheet" id="style-rtl">

    <link href="{{ asset('Backend_assets/assets/css/user-rtl.min.css') }}" type="text/css" rel="stylesheet" id="user-style-rtl">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('Backend_assets/assets/img/favicons/apple-touch-icon.png') }}">
    ...
    <meta name="msapplication-TileImage" content="{{ asset('Backend_assets/assets/img/favicons/mstile-150x150.png') }}">
    ...
    <link href="{{ asset('Backend_assets/assets/css/theme.min.css') }}" type="text/css" rel="stylesheet" id="style-default">
    <link href="{{ asset('Backend_assets/assets/css/user.min.css') }}" type="text/css" rel="stylesheet" id="user-style-default">
...
<body>
    ...
    <script src="{{ asset('Backend_assets/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js') }}"></script>
    <script src="{{ asset('Backend_assets/assets/js/ecommerce-dashboard.js') }}"></script>
    <script src="{{ asset('Backend_assets/unpkg.com/%40googlemaps/markerclusterer%402.0.15/dist/index.min.js') }}"></script>
    <script
